...
const Cart = () => {
  ...
  const tax = (totalCartAmount() * 2) / 100;
  const totalWithTax = totalCartAmount() + tax;
            ...
            <div className="flex items-center md:gap-6 gap-3">
              ...
              >
                <img
                  ...
                  src={`http://localhost:5000/images/${product.image?.[0] || "placeholder.png"}`}
                  alt={product.name}
                />
              </div>
              <div>
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      {Array(Math.max(9, cartItems[product._id]))
                        .fill("")
                        .map((_, index) => (
